    ...
    <Page actionBarHidden="true" class="coverImage">
      <ScrollView orientation="vertical">
        <StackLayout width="100%">
          ...
          <FlexboxLayout class="FlexlistPhotoProfile1" v-if="loadingku ==true">
            <FlexboxLayout class="FlexlistPhotoProfile1" style="margin-top: 50;">
              <Gif class="PhotoLoading" src="~/assets/img/loading.gif" stretch="aspectFit"/>
              <Label class="flexKetQRLabel" color="white">LOADING..!!</Label>
            </FlexboxLayout>
          </FlexboxLayout>


          <FlexboxLayout class="formLayout redemption" v-if="loadingku ==false">
    ...
    methods: {
      ...
      login(){
        ...
        fetch(this.$store.state.url.LOGIN_URL+'login', {
          ...
          await AppSettings.setString("token", result.token);
          await AppSettings.setString("profile",JSON.stringify(result.profile));
